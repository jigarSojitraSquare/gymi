...
import 'package:gymi/core/persistence/PreferenceHelper.dart';
...
class NetworkAuthInterceptor extends SimpleInterceptor {
  ...
  Future<Object?> onRequest(RequestOptions options) async {
    ...
    // } else {
    //   options.headers[HEADER_AUTHORIZATION] = "$HEADER_PROTECTED_AUTHENTICATION_PREFIX ${accessToken.replaceAll('"', '')}";
    // }
    return options;
  }
}
